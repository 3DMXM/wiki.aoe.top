...
LOADSOFLITTLETHINGS
(均衡世界上所有车辆，包括车辆尺寸、最快速度、加速 以及操控性)
...
AMERICAHELICOPTER
(给一辆 Hunter 战斗直升机（以前管这个叫啥来着？阿帕奇？）)
...
THUGSTOOLS
(暴徒套装，给你：手指虎、喷火器、棒球棒、燃烧瓶、手枪、Tec 9、Kruger、散弹枪、狙击步枪)

PROFESSIONALTOOLS
(专业套装，给你：喷火器、RPG、武士刀、遥控C4、.357、短喷、.308 狙击枪)

NUTTERTOOLS
(坚果套装，给你：加特林、电锯、手榴弹、.357、MP、M4、S.P.A.S.12、.308 狙击枪)
